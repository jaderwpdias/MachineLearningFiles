...
# 1. Carregar o dataset Diabetes
diabetes = load_diabetes()
df = pd.DataFrame(diabetes.data, columns=diabetes.feature_names)
print("Dataset Diabetes carregado:")
print(df.head())
...
y = diabetes.target
print(f"\nVariável alvo: Progressão da doença (target)")
print(f"Estatísticas da variável alvo:")
print(pd.Series(y).describe())

# 3. Criar conjuntos de features
# Regressão Linear Simples - usando 'bmi' (índice de massa corporal)
X1 = df[['bmi']]

# Regressão Múltipla - usando 'bmi', 'age', 'sex'
Xn = df[['bmi', 'age', 'sex']]
...
plt.title('Coeficientes da Regressão Múltipla (Diabetes)')
...
if metricas_multipla[3] > metricas_simples[3]:
    ...
    print("Isso ocorre porque a inclusão de mais variáveis (age e sex)")
    print("permite capturar mais informações sobre a progressão da doença.")
...
# 12. Informações sobre o dataset
print("\n" + "="*50)
print("INFORMAÇÕES SOBRE O DATASET DIABETES")
print("="*50)
print("O dataset de diabetes contém dados de 442 pacientes com diabetes.")
print("A variável alvo é uma medida quantitativa da progressão da doença um ano após o baseline.")
print("Features utilizadas:")
print("- bmi: Índice de massa corporal")
print("- age: Idade em anos")
print("- sex: Sexo (1 = masculino, -1 = feminino)")
print("Este dataset é comumente usado para demonstrar técnicas de regressão linear.")
