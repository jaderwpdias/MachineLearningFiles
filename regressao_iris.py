...
plt.tight_layout()
plt.savefig('images/regressao_simples_previsto_vs_real.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('images/regressao_simples_residuos.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('images/regressao_multipla_previsto_vs_real.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('images/regressao_multipla_residuos.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('images/coeficientes_regressao_multipla.png', dpi=300, bbox_inches='tight')
plt.show()
